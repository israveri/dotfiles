...
vim.api.nvim_create_autocmd("FileType", {
    pattern = "nvim-undotree",   -- matches the default undo tree buffer name
    callback = function()
        vim.keymap.set("n", "q", ":close<CR>", { buffer = true, nowait = true })
    end,
})
...
vim.api.nvim_create_autocmd("LspAttach", {
    callback = function(event)
        ...
        vim.keymap.set({ "n", "x" }, "gra", function() require("fzf-lua").lsp_code_actions() end,
        ...
        vim.keymap.set("n", "gri", function() require("fzf-lua").lsp_implementations() end,
        { buffer = event.buf, desc = "LSP: [G]oto [I]mplementation" })

        -- Jump to the definition of the word under your cursor.
        --  This is where a variable was first declared, or where a function is defined, etc.
        --  To jump back, press <C-t>.
        vim.keymap.set("n", "grd", function() require("fzf-lua").lsp_definitions() end,
        { buffer = event.buf, desc = "LSP: [G]oto [D]efinition" })

        -- WARN: This is not Goto Definition, this is Goto Declaration.
        --  For example, in C this would take you to the header.
        vim.keymap.set("n", "grD", function() require("fzf-lua").lsp_declarations() end,
        ...
        vim.keymap.set("n", "gW", function() require("fzf-lua").lsp_live_workspace_symbols() end,
        { buffer = event.buf, desc = "LSP: Open Workspace Symbols" })

        -- Jump to the type of the word under your cursor.
        --  Useful when you"re not sure what type a variable is and you want to see
        --  the definition of its *type*, not where it was *defined*.
        vim.keymap.set("n", "grt", function() require("fzf-lua").lsp_typedefs() end,
