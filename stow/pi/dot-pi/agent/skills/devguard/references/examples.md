...
Realworld code examples demonstrating the four principles. Each example shows what LLMs commonly do wrong and how to fix it.
...
Would need more info for filebased exports.
...
def calculate_discount(amount: float, percent: float) > float:
    """Calculate discount amount. percent should be 0100."""
...
### Example 2: MultiStep with Verification
...
# configuration system, and monitoring in one 300line commit
...
1. Add basic inmemory rate limiting (single endpoint)
   Verify:
...
3. Add Redis backend (for multiserver)
   Verify:
...
### Example 3: TestFirst Verification
...
| GoalDriven | "I'll review and improve the code" | "Write test for bug X → make it pass → verify no regressions" |
